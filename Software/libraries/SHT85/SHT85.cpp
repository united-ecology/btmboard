...
/*
bool SHT::begin(const uint8_t address, const uint8_t dataPin,
...
bool SHT::begin(const uint8_t address, SoftwareWire *wire) {
  if ((address != 0x44) && (address != 0x45)) {
    return false;
  }
  _address = address;
...
bool SHT::begin(SoftwareWire *wire) { return begin(SHT_DEFAULT_ADDRESS, wire); }
...
//  DERIVED
//
SHT30::SHT30() { _type = 30; };

SHT31::SHT31() { _type = 31; };

SHT35::SHT35() { _type = 35; };

SHT85::SHT85() { _type = 85; };
